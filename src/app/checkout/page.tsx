...
export default async function CheckoutPage() {
  ...
  return (
    <div className="page-shell space-y-6">
      <div>
        <p className="text-sm uppercase tracking-eyebrow-wide text-mist">Checkout</p>
        <h1 className="text-3xl font-black uppercase tracking-display text-sand sm:text-4xl">
          Confirmá tu compra
        </h1>
